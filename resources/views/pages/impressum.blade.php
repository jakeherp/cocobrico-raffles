...
@section('content')
    ...
    <section class="row" id="content">
      ...
      <div class="large-12 column">
        <h1><i class="fa fa-bank"></i> Impressum</h1>
        ...
        <div class="callout">
          <div class="row">
            <div class="large-6 small-12 columns">
              ...
              Schweiz</p>
              <p>
                <strong>Telefon:</strong> +41 41 712 11 88<br>
                <strong>Email:</strong> <a href="mailto:europe@cocobrico.com">europe@cocobrico.com</a>
              </p>
            </div>
            <div class="large-6 small-12 columns">
