			...
			<tbody>
				<tr>
					<td width="70%">
                        ...
                        <strong>Reservierungsnummer:</strong> {{ $user->raffles()->where('raffle_id', $raffle->id)->first()->pivot->code }}<br>
					...
					<td width="30%">
						...
						<img src="{{ URL::asset($file->path) }}" style="width:150px; margin-top:150px; float: right;">
				  	  @endif
					</td>
				</tr>
				<tr>
